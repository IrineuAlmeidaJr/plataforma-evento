...
export function Spinner() {
  return (
    <div className="flex flex-col gap-4 justify-center items-center h-[25%]">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        className="w-[100px] h-[100px] text-gray-200 animate-spin dark:text-gray-300 fill-blue-500"
        viewBox="0 0 100 101"
      >
        <path
          fill="currentColor"
